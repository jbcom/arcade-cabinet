...
| Enchanted Forest | Draw a rune and see shield/heal/purify feedback. | Learn alternating spells builds harmony. | Defend readable grove waves with spell cadence. | Waves are cadence-based, not sudden failure spikes. | Pointer/touch rune drawing. | Better spell grammar and longer harmony runs. |
