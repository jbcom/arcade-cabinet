...
export function HUD() {
  ...
  return (
    <HUDOverlay
      topLeft={
        <div>
          <div style={{ fontSize: 12, letterSpacing: "2px", color: "#aaa", textTransform: "uppercase" }}>Voxel Realms</div>
      ...
      topRight={
        <div style={{ textAlign: "right" }}>
          <div style={{ fontSize: 12, letterSpacing: "2px", color: "#aaa", textTransform: "uppercase" }}>HP</div>
