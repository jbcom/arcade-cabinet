...
import { snwWorld, snwEntity } from "./store/world";
...
function SNWApp() {
  ...
  const handleStart = () => {
    snwEntity.set(SNWTrait, { phase: "playing", hp: 100, maxHp: 100, score: 0, level: 1, xp: 0, xpNeeded: 5, wave: 1, waveTime: 0, kills: 0 });
  };
      ...
      {state.phase === "playing" && (
        <>
          ...
          <div style={{
            ...
            width: 20, height: 20, border: "2px solid rgba(0, 255, 204, 0.5)", borderRadius: "50%", pointerEvents: "none"
          }}>
            <div style={{ position: "absolute", top: "50%", left: "50%", width: 4, height: 4, background: "#00ffcc", borderRadius: "50%", transform: "translate(-50%, -50%)" }} />
          </div>
        </>
      )}
