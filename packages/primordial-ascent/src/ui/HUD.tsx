      ...
      <HUDOverlay
        topLeft={
          <div className="z-10 relative">
            <div style={{ fontSize: 12, letterSpacing: "2px", color: "#aaa", textTransform: "uppercase" }}>Altitude</div>
            <div style={{ fontSize: 32, fontWeight: 900, color: "#00ff66", textShadow: "0 0 10px rgba(0,255,102,0.5)", fontVariantNumeric: "tabular-nums" }}>
              {state.altitude}M
            </div>
          </div>
        }
        topRight={
          <div style={{ textAlign: "right" }} className="z-10 relative">
            <div style={{ fontSize: 12, letterSpacing: "2px", color: "#aaa", textTransform: "uppercase" }}>Velocity</div>
            <div style={{ fontSize: 32, fontWeight: 900, color: "#00ff66", textShadow: "0 0 10px rgba(0,255,102,0.5)", fontVariantNumeric: "tabular-nums" }}>
              {state.velocity}
            </div>
          </div>
        ...
        bottomLeft={
          <div className="z-10 relative">
             <div style={{ fontSize: 12, letterSpacing: "2px", color: "#aaa", textTransform: "uppercase" }}>Chronometer</div>
             <div style={{ fontSize: 32, fontWeight: 900, color: "white", textShadow: "0 0 10px rgba(255,255,255,0.5)", fontVariantNumeric: "tabular-nums" }}>
