...
import {
  ...
  tickGame,
  toggleHeatmap,
} from "@logic/games/gridizen/engine/logic";
import type { GridizenState } from "@logic/games/gridizen/engine/types";
import { TICK_RATE_MS } from "@logic/games/gridizen/engine/types";
import { GridizenTrait } from "@logic/games/gridizen/store/traits";
import { gridEntity, gridWorld } from "@logic/games/gridizen/store/world";
