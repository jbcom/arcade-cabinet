...
import { createInitialSNWState } from "@logic/games/protocol-snw/engine/protocolSimulation";
import { SNWTrait } from "@logic/games/protocol-snw/store/traits";
import { snwEntity, snwWorld } from "@logic/games/protocol-snw/store/world";
