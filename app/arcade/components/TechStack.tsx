const TECH = [
  ...
  {
    name: "React Router",
    description: "Clean cabinet routes and fullscreen game launches.",
    color: "#f97316",
    icon: "◎",
  },
  {
  ...
  {
    name: "TypeScript",
    description: "Typed logic and view boundaries inside one app.",
    color: "#06b6d4",
    icon: "TS",
  },
  {
  ...
  {
    name: "Capacitor",
    description: "One Android shell built from the same web cabinet.",
    color: "#ef4444",
    icon: "◻",
  },
];
