...
const gameCards = [
  {
    ...
    description:
      "3D command-table city building with quotas, utilities, and giant concrete ambition.",
    Component: SimSoviet,
  },
  {
    id: "otterly-chaotic",
    ...
    description:
      "3D animal-action sprint with spherical characters, goats, and a rolling Kudzu ball.",
  ...
  return (
    <section style={{ maxWidth: 1400, margin: "0 auto", padding: "0 2rem 6rem" }}>
      <div style={{ marginBottom: "2rem", textAlign: "center" }}>
        ...
        >
          Playable games directly on the landing page
        </h2>
      </div>
        ...
        {gameCards.map(({ id, title, description, Component }) => (
          ...
          >
            <div style={{ marginBottom: "1rem" }}>
              ...
              <a href={`/games/${id}`} style={{ color: "#7dd3fc", textDecoration: "none" }}>
                Open isolation page →
              </a>
            </div>
